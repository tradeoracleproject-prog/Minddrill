...
function DesktopTipBanner() {
  ...
  return (
    <div id="desktopTipBanner" style={{ display: "block" }}>
      ...
      <button onClick={() => setShow(false)} style={{ marginTop: 12, background: "none", border: "1px solid rgba(255,255,255,0.2)", color: "rgba(255,255,255,0.55)", borderRadius: 50, padding: "8px 16px", fontSize: 11, fontWeight: 700, cursor: "pointer", width: "100%" }}>Don't show this again</button>
    </div>
  );
}
